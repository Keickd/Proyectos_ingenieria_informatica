...
class PostActorAsyncTask : AsyncTask<Actor, Void, Int>() {

    override fun doInBackground(vararg params: Actor?): Int {
        var result : String = ""
        val url = URL("http://$SERVER:8888/user/$ADDACTOR.php?user=$USER&pass=$PASSWORD")
