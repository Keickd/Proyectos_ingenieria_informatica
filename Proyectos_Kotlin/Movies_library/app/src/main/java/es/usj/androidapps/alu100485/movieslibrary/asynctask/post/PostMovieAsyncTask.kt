...
class PostMovieAsyncTask: AsyncTask<Movie, Void, Int>() {
    override fun doInBackground(vararg params: Movie?): Int {
        var result : String = ""
        val url = URL("http://$SERVER:8888/user/$ADDMOVIE.php?user=$USER&pass=$PASSWORD")
